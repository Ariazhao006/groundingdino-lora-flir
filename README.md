...
![Grounding DINO 结构](groundingdino_framework.png)
...
### 4. `flir_lora_plateau_c_sched_smooth_ema_e20` ⭐ Stage 1
...
### 5. `flir_lora_stageb_warmrestart_e24` ⭐ Stage 2
...
### 6. `flir_lora_stageb_plus8_gentle_rerun` ⭐ Stage 3
...
---
## 7.checkpoint文件
可以从[hugging face 仓库](https://huggingface.co/Ariazhao006/groundingdino-lora-flir-checkpoints)里下载
只保留了三个阶段、失败的融合方案、一次跑到底的ema20实验
